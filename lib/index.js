...
export default class Timeline extends Component {
  ...
  renderTime = (item, index) => {
    ...
    let { timeContainerStyle, timeStyle, timeMeridiumStyle, renderTimeBottom, showAmPm, timeFormat, columnFormat, relativeTime } = this.props;
    switch(columnFormat){
      case 'single-column-left':
    ...
    if (typeof(item.time) === 'string') {
      ...
      if (relativeTime) {
          hourFormat = moment().startOf('day').fromNow()
      } else {
